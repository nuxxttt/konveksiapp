            ...
            <div class="card-body">
                        <form method="POST" action="{{url('/kontigen')}}">
                            ...
                            <div class="my-3 col-md-6">
                                ...
                                <input type="text"  required name="kontigen" id="kontigen" class="form-control">
                            </div>
                            <div class="my-3 col-md-6">
                                <label for="manager" class="form-label">Nama Manager/Kepala Sekolah</label>
                                <input type="text" required name="manager" id="manager" class="form-control">
                            </div>
                            <div class="my-3 col-md-6">
                                <label for="official" class="form-label">Official/Guru Pembimbing</label>
                                <input type="text" required name="official" id="official" class="form-control">
                            </div>
                            <div class="my-3 col-md-6">
                                <label for="nomorhp" class="form-label">No HP</label>
                                <input type="number"  required name="hp" id="nomorhp" class="form-control">
                            </div>
                            {{-- <div class="col-lg-6">
                            ...
                            <div class="my-3 col-md-6">
                                ...
                                <textarea name="alamat" required  class="form-control" id="example-textarea"
                                    rows="5"></textarea>
